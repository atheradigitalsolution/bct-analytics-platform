...
--
-- WHY NOT list_price. list_price is the SALES price. Valuing inventory at it
-- overstates by the entire margin - the same shape as summing PPOB
-- pass_through_amount and calling it revenue: a plausible column that is wrong
-- by a large factor. In this database list_price runs roughly 2x
-- standard_price.
--
